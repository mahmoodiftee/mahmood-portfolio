...
function ButtonCreativeRight({ children }: { children: React.ReactNode }) {
    return (
        <>
            <div className='group relative cursor-pointer p-2 w-32 border bg-white rounded-full overflow-hidden text-black text-center font-semibold'>
                ...
                <div className='absolute top-[40%] left-[10%] h-2 w-2 group-hover:h-full group-hover:w-full rounded-lg bg-(--foreground) scale-[1] dark:group-hover:bg-(--background) group-hover:scale-[1.8] transition-all duration-300 group-hover:top-[0%] group-hover:left-[0%] '></div>
            </div>
        </>
    );
}
